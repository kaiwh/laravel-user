        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('desktop.user.address.create') }}"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="@Lang('desktop::userAddress.form.name')"  required>
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input id="mobile" type="text" class="form-control" name="mobile" value="{{ old('mobile') }}" placeholder="@Lang('desktop::userAddress.form.mobile')"  required>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input id="address" type="text" class="form-control" name="address" value="{{ old('address') }}" placeholder="@Lang('desktop::userAddress.form.address')"  required>
